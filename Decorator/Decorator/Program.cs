...
namespace DotNetDesignPatternDemos.Structural.Decorator.CodeBuilder
{
    ...
    //In this example we just add new behaviour to existing stringbuilder class.
    //We implemented every method from sb and added ours.
    //the return type of sb methods is no longer StringBuilder, but instead our own class CodeBuilder
