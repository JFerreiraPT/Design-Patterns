//The away code was built on dynamicDecorator have a potential problem, cycles
//Its possible to create a 2 times a shape color object, so an object can become red and blue for example

//var circle = new Circle(2);
//var colored = new ColorShape(circle, "red");
//var colored2 = new ColorShape(colored, "blue");
