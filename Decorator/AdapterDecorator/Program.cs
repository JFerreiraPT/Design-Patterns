//The goal is to be able to use + operator on StringBuilder like we do on strings!!
...
namespace DotNetDesignPatternDemos.Structural.AdapterDecorator
{
    public class MyStringBuilder
    {
        ...
        //implicitly converts string in MyStringBuilder
        //This way we can do MyStringBuilder = "Any String we want";
